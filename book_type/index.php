    ...
    <div class="main-body pd-20px w-100pct">
      ...
      <div>
        <?php
          ...
          $strSQL = "SELECT  * FROM CATEGRORY";
          $objParse = oci_parse ($objConnect, $strSQL);
          oci_execute ($objParse);
        ?>
        <table class="table is-bordered">
          <tr>
            <th class="t-al-center">รหัสประเภทหนังสือ</th>
            <th class="t-al-center">ชื่อประเภทหนังสือ</th>
          ...
          <tr>
            <td class="t-al-center">
              <?php echo $objResult["CAT_ID"];?>
            </td>
            <td>
              <?php echo $objResult["CAT_NAME"];?>
            </td>
            <td>
